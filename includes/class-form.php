 ...
 * Form Class
 * 
 * This class is used to handle all Lingo form needs: rendering, validation
 * and filtering.
 * 
...
class Lingo_Form
{
    ...
    public function get_validator( $name ) {
        $validators = Lingo::instance()->get("field_validator", array());
    ...
    public function load( $form ) {
        $this->_scheme = apply_filters("lingo_form_load", $form);
    }
    ...
    public function bind( $data ) {
        ...
        $fields = Lingo::instance()->get("form_field");
        ...
        do_action( "lingo_form_bind", $this, $data );
    }
            ...
            foreach( $field["validator"] as $v ) {
                ...
                if( isset($v["message"][$result]) ) {
                   ...
                   $this->_form[$name]["error"][] = str_replace($find, $repl, $v["default_error"]); 
                    ...
                    $this->_form[$name]["error"][] = __( "Invalid value.", "lingo" );
                }
     ...
     * - type: (default !lingo_field_hidden) show or hide fields based on type
     * 
     * @param array $options
     * @return array
     */
    public function get_fields( $options = array() ) {
        ...
        if(isset($options["type"]) && is_array($options["type"])) {
            ...
            $type_include = array();
            $type_exclude = array( 'lingo_field_hidden' );
        }
